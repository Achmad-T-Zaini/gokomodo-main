...
class GUISaleReport(models.Model):
    _name = "gui.sale.report"
    _description = "Sales Analysis Report Gokomodo"
    _auto = False
    _rec_name = 'date'
    _order = 'date desc'
    ...
    order_type_id = fields.Many2one('sdt.order.type','Order Type')
    ...
    def _select_sale(self, fields=None):
        ...
        select_ = """
            ...
            count(*) as nbr,
            s.name as name,
            s.order_type_id as order_type_id,
    ...
    def _from_sale(self, from_clause=''):
        from_ = """
                sale_order_line l
                      ...
                      left join sdt_order_type sot on sot.id=s.order_type_id 
